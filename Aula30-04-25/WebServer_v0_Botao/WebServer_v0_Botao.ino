...
const char* ssid = "Larissa";
const char* password = "Larissa362";
      ...
      if (client.available()) {             // Se há bytes para ler do cliente
        ...
        if (c == '\n') {                    // Se o byte é um caractere de nova linha
          ...
          if (currentLine.length() == 0) {
            ...
            // Mostrar estado atual e botões ON/OFF para o LED azul (GPIO 2)
            client.println("<p>LED Azul (GPIO 2) - Estado " + output2State + "</p>");
            if (output2State == "off") {
